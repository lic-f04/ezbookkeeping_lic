...
var (
	...
	ErrNotAllowChangeParentTransactionType     = NewNormalError(NormalSubcategoryCategory, 9, http.StatusBadRequest, "not allow to change transaction category parent with different type")
)
