...
var (
	...
	ErrTransactionAmountCalculationMismatch                        = NewNormalError(NormalSubcategoryTransaction, 42, http.StatusBadRequest, "transaction amount does not match quantity × price")
	ErrTransactionQuantityInvalid                                  = NewNormalError(NormalSubcategoryTransaction, 43, http.StatusBadRequest, "[transactions.TransactionImportHandler] quantity of transaction index:%d is invalid")
	ErrTransactionUnitPriceInvalid                                 = NewNormalError(NormalSubcategoryTransaction, 44, http.StatusBadRequest, "[transactions.TransactionImportHandler] unit price of transaction index:%d is invalid")
)
